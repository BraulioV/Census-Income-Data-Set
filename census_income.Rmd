...
El enfoque que usaremos para predecir la variable *income* es realizar tres modelos diferentes, cada uno con sus ventajas y desventajas, siendo uno un modelo ___paramétrico___, un modelo ___KNN___ y un modelo basado en una ___red neuronal multicapa___.

  * ___Modelo paramétrico___: el modelo elegido en este caso es __Random Forest__. La modificación de los parámetros se realizará mediante validación cruzada, para estimar los parámetros de la mejor forma posible.
  * ___Función de base radial___: en este caso, usaremos un modelo de __Support Vector Machine__, el cual, tendrá un kernel con una función de base radial. 
  * ___Red neuronal multicapa___
...
=======
adult.train.clean = adult.train[rowsMissingValues == 0,]
>>>>>>> 5d034c605146e8678345d77c9fa38761051b8c04
```
