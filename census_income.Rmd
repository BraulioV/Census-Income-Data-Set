...
getPerfomance <- function(model, norm = F, newdata = adult.test.clean, svmPred = F, nnetOrGlm=F,...){
  set.seed(1)
  print("holi")
...
plot(getPerfomance(model = svmModelReg_09, svmPred = T),lwd=2,col=3,add=T)
...
plot(getPerfomance(model = model.nnet, newdata = adult.test.clean.norm,
  type="raw", nnetOrGlm = T),lwd=2,col=5,add=T)
abline(a=0,b=1,lwd=2,lty=2,col="gray")
legend("bottomright",col=c(2:6),lwd=2,legend=c("Regresión logística","Random Forest","SVM","KNN","Red Neuronal"),bty='n') 
```
