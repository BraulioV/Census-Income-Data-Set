...
```{r}
apply(X=adult.train, MARGIN=2, FUN=function(columna) length(is.na(columna)))
```

En todas las columnas hay el mismo número de variables pérdidas.
...
rowsMissingValues = apply(X=x, MARGIN=1,
