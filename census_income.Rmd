...
outOfSampleErrorOccupation <- function(newdata = adult.test.clean.norm,  
...
model.nnet.occupation = nnet(formula = occupation ~ ., maxit=10000, 
    data = adult.train.clean.norm, size = 8, decay=0.1,trace=F)
outOfSampleError(model.nnet.occupation, adult.test.clean.norm, type="class")
```
