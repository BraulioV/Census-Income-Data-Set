...
Para intentar mejorar el modelo, haremos una versión del modelo $SVM$ que utilizará la función `tune` para ir probando con distintos valores para cada uno de los parámetros, devolviéndonos el mejor modelo encontrado, junto con información del valor de los parámetros usados.
