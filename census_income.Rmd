...
>>>>>>> 102b0deba149382ce44e01569b550505092537db
...
El uso de los modelos de \textit{Support Vector Machine} es muy apropiado para el problema, ya que funciona bastante bien con los problemas de clasificación binaria, como es el caso, ya que ofrece una aproximación muy natural al problema, y ofrece un buen comportamiento en problemas con grandes dimensiones, gracias al uso del *Kernel*.

### Parámetros del problema

Los parámetros a ajustar del problema son:
