...
Además, los modelos $SVM$, tienen un comportamiento muy bueno frente a conjuntos de datos con clases desbalanceadas, como es nuestro caso, donde la clase con un valor de $income = ``<=50K''$ representa un subconjunto mucho mayor que la clase con $income = ``>50K''$, como podemos ver en [@unbalanced].
...
Como vemos, el error fuera de la muestra supone un 14\% de $E_{out}$
