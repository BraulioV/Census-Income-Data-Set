...
Un modelo de base radial es aquel que ajusta el peso de los datos en función de la distancia a la que se encuentra un punto $v$ de $u$. Esto se conoce como el $kernel$ del modelo, donde, para los modelos de base radial, este peso se ajusta de la forma $$w(u,v)=e^{-\gamma\cdot|u-v|^2}$$
